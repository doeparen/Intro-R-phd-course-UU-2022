...
4. Construct a tf-idf object (i.e. term frequency–inverse document frequency) and compare look up the five words with the highest score for each document. Compare how and think about why they differ from the 5 most frequently used words (task B.3).
