...
3. Common "set of words" types: __dictionary__ (e.g. your corpus' words), __stop words__ (insignificant words to exclude from the data), and __lexicons__ ([pre-made] word lists for categorizing your dictionary needed for particular tasks)
...
1a. __Bag-of-words__ (analyzing your words stripped of their placement in each document)

--

1b. __DTM__ (document-term matrix) or __DFM__ (document-feature matrix), __tidy text tibble__ (each row is a word) or __TF-IDF__ (term frequency-inverse document frequency)

--

2a. __Word vectors__ (including statistics on each words neighbors in the text)

--

2b. __Vector space__ (multi-dimensional representation of all words based on their co-occurrences)
