...
1a. The __bag-of-words model__ (words are stripped of their placement in sentences so that each document is reduced to a "bag" containing only word frequencies)
...
2a. __Word vectors__ (includes statistics on each words' neighbors in the text)
